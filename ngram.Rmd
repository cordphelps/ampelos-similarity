...
gg <- ggplot() +
    ...
    geom_text(data=oak.tibl, aes(y = mean, x = variance, label = data_label), vjust = -1, size = 3) +
    geom_text(data=control.tibl, aes(y = mean, x = variance, label = data_label), vjust = -1, size = 3) +
