...
color_list <- list("royalblue4", "royalblue3", "royalblue2", "darkorange4", "darkorange3", "darkorange2")
    ...
    geom_smooth(method = "lm", se = TRUE) +
      ...
      geom_boxplot(data=si.ngram.tibl, aes(x = stacked_ngram, y = 0.2), width=0.1) +
      
      geom_boxplot(data=si.ngram.tibl, aes(x = stacked_sim, y = 0.3), width=0.1) +
    ...
    labs(y = "sorensen", 
         x = paste("ngram",
                   sep=""),
         caption = paste("correlation coefficient: ", coeff, sep="" ))
