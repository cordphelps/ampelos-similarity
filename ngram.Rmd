...
#print(paste("mean: ", mean(dist1, na.rm = TRUE), sep=""))
...
#print(paste("mean: ", mean(dist4, na.rm = TRUE), sep=""))
#print(coda::HPDinterval(as.mcmc(dist4), prob=0.95) )
...
ggplot(posterior.tibl) +
  ...
  geom_density(aes(x = dist1), fill = "purple3", alpha = 0.6) +
  
  geom_density(aes(x = dist2), fill = "purple", alpha = 0.6) +
  
  geom_density(aes(x = dist3), fill = "slateblue4", alpha = 0.6) +
  
  geom_density(aes(x = dist4), fill = "orchid3", alpha = 0.6) +
  
  geom_density(aes(x = dist5), fill = "violet", alpha = 0.6) +
  
  geom_density(aes(x = dist6), fill = "plum1", alpha = 0.6) +
  
  
  labs(x = "simulated probability of occurance", 
       y = "relative liklihood (density)")
...
#print(dist4.stats[1] ) # lower credible interval
#print(dist4.stats[2] ) # upper credible interval
#print(dist4.stats)
...
ggplot(posterior.tibl) +
  ...
  geom_density(aes(x = dist4), fill = "violet", alpha = 0.6) +
...
ggplot() +
  ...
  geom_pointrange(aes(y = factor(column_list[8]), x = mean(dist4, na.rm = TRUE), xmin = dist4.stats[1], xmax = dist4.stats[2], color = "orange")) +

  geom_pointrange(aes(y = factor(column_list[2]), x = mean(dist1, na.rm = TRUE), xmin = dist1.stats[1], xmax = dist1.stats[2], color = "green"))


gg.ci.week1 <- ggplot(posterior.tibl) +
  
  geom_density(aes(x = dist2), fill = "purple3", alpha = 0.6) +
...
gg.ci.week2 <- ggplot() +
  ...
  geom_pointrange(aes(y = factor('a'),
