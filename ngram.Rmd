...
temp.tibl$normalized_value <- temp.tibl$value / sum(temp.tibl$value, na.rm = TRUE)
...
for (daytime in list("am", "pm")) {
    ...
    if (daytime == 'am') {
      ...
      dist1 = temp.tibl$normalized_value
    ...
    gg.dist <- ggplot(temp.tibl) +
      
      geom_dotplot(aes(value), stackdir="up", binwidth = 0.01) +
